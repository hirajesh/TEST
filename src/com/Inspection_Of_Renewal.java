...
public class Inspection_Of_Renewal {
	
	
	WebDriver driver;
	Pageaccess kdmc=new Pageaccess(driver);
	String ApplicatName="GANAGA";
	String Nursinghome="GANGA NURSING HOME";
	String DoctorName="GANGA";
...
public void Inspect() throws InterruptedException
{
	...
	WebElement open=driver.findElement(By.xpath("//*[@id='phpid']/a"));
	kdmc.Clickactions(open);
    Thread.sleep(2000);
    kdmc.clicks(1, "//*[@id='phpid']/ul/li[5]/a");
    Thread.sleep(2000);
