...
public class StoreAllMedicine {
	...
	public void PharmacyREQUEST() throws InterruptedException
	{
		   ...
		   Thread.sleep(3000);
		   try {
			   WebElement inventory=driver.findElement(By.xpath("//*[@id='connector']/div[3]/aside[1]/section/ul/li[5]/a"));
	...
	/*	WebElement	category = driver.findElement(By.id("optcategory"));
		...
		Pharmacy_Rno = driver.findElement(By.id("txtno")).getAttribute("value").trim();
			...
			System.out.println("* STORE REQUEST ALERT :"+Pharmacyreqalert);
			...
			System.out.println(" ");
			System.out.println("* STORE REQUEST SEND SUCCESSFULLY ");
			System.out.println("* STORE REQUEST NUMBER :"+Pharmacy_Rno);
